...
//     if (!request) {
//    throw new NotFoundError(`Request with ID ${requestId} not found or could not be updated`);
//     }
...
//        throw new ValidationError({ general: "Missing user or agency info in approved request" });
//       }
